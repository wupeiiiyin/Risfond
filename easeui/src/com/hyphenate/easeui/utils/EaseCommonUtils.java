...
public class EaseCommonUtils {
    ...
    public static EMMessage createExpressionMessage(String toChatUsername, String groupName, String txt, String codeId) {
        EMMessage message = EMMessage.createTxtSendMessage("[" + txt + "]", toChatUsername);

        message.setAttribute(EaseConstant.MESSAGE_TXT_GIF_GROUP_NAME, groupName);
        message.setAttribute(EaseConstant.MESSAGE_TXT_GIF_CODE_ID, codeId);
        message.setAttribute(EaseConstant.MESSAGE_TXT_TYPE, EaseConstant.MESSAGE_TXT_TYPE_VALUE);
    ...
    public static void showCopy(final Context context, final String content) {
        final Dialog bottomDialog = new Dialog(context, com.hyphenate.easeui.R.style.CopyDialog);
        ...
        contentView.findViewById(R.id.copy).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ClipData mClicpData = ClipData.newPlainText("Label ", content);
                mClipboardManager.setPrimaryClip(mClicpData);
            }
        });
