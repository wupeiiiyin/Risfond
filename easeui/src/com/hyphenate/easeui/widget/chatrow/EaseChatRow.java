...
public abstract class EaseChatRow extends LinearLayout {
    ...
    protected List<EMMessage> emMessages;
    ...
    protected int mMinItemWith;// 设置语音对话框的最大宽度
    protected int mMaxItemWith;// 设置语音对话框的最小宽度

    public EaseChatRow(Context context, EMMessage message, int position, BaseAdapter adapter,List<EMMessage> emMessages) {
        super(context);
    ...
    public void setUpView(EMMessage message, int position,
                          EaseChatMessageList.MessageListItemClickListener itemClickListener,List<EMMessage> emMessages) {
        this.message = message;
        this.position = position;
    ...
    private void setUpBaseView() {
        ...
        try {
            GlideUtil.downLoadHeadImage(context, message.getStringAttribute("nickUrl"), userAvatarView, new RoundedCornersTransformation(context, 0, 0));
        ...
        if (adapter instanceof EaseMessageAdapter) {
            ...
            if (usernickView != null) {
                if (((EaseMessageAdapter) adapter).isShowUserNick()) {
                    usernickView.setText(message.ext().get("nickName").toString());
