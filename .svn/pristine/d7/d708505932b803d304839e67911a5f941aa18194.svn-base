...
public class CustomerSearchImpl implements ICustomerSearch {
    CustomerSearchResponse response;

    @Override
    public void customerSearchRequest(String token, Map<String, String> request, String url, final ResponseCallBack callBack) {
        ...
        HttpUtil.getInstance().requestService(url, request, token, new ResponseListener() {
            ...
            public void onSuccess(String str) {
                if (JsonUtil.isJson(str)) {
                    response = JsonUtil.fromJson(str, CustomerSearchResponse.class);
                    if (response != null) {
