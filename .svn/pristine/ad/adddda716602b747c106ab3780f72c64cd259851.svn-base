...
public class EaseChatRowBigExpression extends EaseChatRowText {
    ...
    public EaseChatRowBigExpression(Context context, EMMessage message, int position, BaseAdapter adapter,List<EMMessage> emMessages) {
    ...
    public void onSetUpView() {
        String emojiconId = message.getStringAttribute(EaseConstant.MESSAGE_TXT_GIF_CODE_ID, null);
        ...
        if (emojicon != null) {
            if (emojicon.getBigIcon() != 0) {
                GlideUtil.downLoadGif(context, emojicon.getBigIcon(), imageView);
