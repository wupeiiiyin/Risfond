...
public class WorkOrderDetail {
     ...
     * InCallTimeStr : 2017-10-09 15:50
     * Location : 0201
     * LocationDefinition : 和平区
     * ConsultationType : 1
     * ConsultationTypeDefinition : 电话咨询
     * Industry : 43
     * IndustryDefinition : 餐饮服务
     * CompanyName : 四川成双防腐材料有限公司
     * LinkMan : 666
     * LinkPhone : 18066666666
     * JobDescription : 备注：企业通过APP注册提交的招聘需求，请尽快受理.职位：999
     * IsOffer : 0
     * AddTime : 2017-10-17T17:40:28.3
     * AddTimeStr : 2017-10-17 17:40
     * CreatorStaffId : 2
     * CreatorName : 黄小平
     * CreatorCompany : 1
     * Status : 1
     * StatusDefinition : 未接收
    ...
    public void setInCallTimeStr(String InCallTimeStr) {
        this.InCallTimeStr = InCallTimeStr;
    }
