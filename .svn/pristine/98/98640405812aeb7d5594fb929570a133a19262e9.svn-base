...
import com.risfond.rnss.entry.RecommendProcessResponse;
...
public class RecommendProcessImpl implements IRecommendProcess {
    RecommendProcessResponse response;

    @Override
    public void recommendProcessRequest(String token, Map<String, String> request, String url, final ResponseCallBack callBack) {
        ...
        HttpUtil.getInstance().requestService(url, request, token, new ResponseListener() {
            ...
            public void onSuccess(String str) {
                if (JsonUtil.isJson(str)) {
                    response = JsonUtil.fromJson(str, RecommendProcessResponse.class);
                    if (response != null) {
