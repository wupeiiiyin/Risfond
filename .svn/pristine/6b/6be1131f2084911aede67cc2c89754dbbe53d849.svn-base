...
public class EaseChatRowVoice extends EaseChatRowFile {
    ...
    protected void onSetUpView() {
        ...
        if (len > 0) {
            ...
            ViewGroup.LayoutParams lParams = bubbleLayout.getLayoutParams();
            lParams.width = (int) (mMinItemWith + mMaxItemWith / 60f * voiceBody.getLength());
            bubbleLayout.setLayoutParams(lParams);
        } else {
