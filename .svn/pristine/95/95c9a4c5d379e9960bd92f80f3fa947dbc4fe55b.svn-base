...
/**
 * Created by Abbott on 2017/11/10.
 */

public class ResumeSearchWholeAdapter extends RecyclerView.Adapter{

    private Context context;
    private List<ResumeSearchAll> data;

    public ResumeSearchWholeAdapter(Context context, List<ResumeSearchAll> data) {
    ...
    private ResumeSearchWholeAdapter.OnItemClickListener mOnItemClickListener;

    public void setOnItemClickListener(ResumeSearchWholeAdapter.OnItemClickListener mOnItemClickListener) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        ResumeSearchWholeAdapter.ResumeViewHolder holder = new ResumeSearchWholeAdapter.ResumeViewHolder(view);
        return holder;
    }
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        if (holder instanceof ResumeSearchAdapter.ResumeViewHolder) {
            ResumeSearchWholeAdapter.ResumeViewHolder mholder = (ResumeSearchWholeAdapter.ResumeViewHolder) holder;
            ResumeSearchAll search = data.get(position);
    ...
    public void updateData(List<ResumeSearchAll> data) {
        this.data = data;
