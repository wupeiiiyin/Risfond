...
public class RecommendPeopleImpl implements IRecommendPeople {
    RecommendPeopleResponse response;
        ...
        HttpUtil.getInstance().requestService(url, request, token, new ResponseListener() {
            ...
            public void onSuccess(String str) {
                if (JsonUtil.isJson(str)) {
                    response = JsonUtil.fromJson(str, RecommendPeopleResponse.class);
                    if (response != null) {
