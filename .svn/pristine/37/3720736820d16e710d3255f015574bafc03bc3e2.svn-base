...
public class EaseVoiceRecorderView extends RelativeLayout {
    ...
    protected ImageView micImage, voiceImage;
    ...
    protected Handler micImageHandler = new Handler() {
        ...
        public void handleMessage(android.os.Message msg) {
            // change image
            int voiceLevel = msg.what;
            if (voiceLevel > 6) {
                voiceLevel = 6;
            }
            micImage.setImageDrawable(micImages[voiceLevel]);
        }
    };
    ...
    private void init(Context context) {
        ...
        voiceImage = (ImageView) findViewById(R.id.iv_voice_image);
        recordingHint = (TextView) findViewById(R.id.recording_hint);

        voiceRecorder = new EaseVoiceRecorder(micImageHandler);

        // animation resources, used for recording
        micImages = new Drawable[]{getResources().getDrawable(R.mipmap.v1),
                getResources().getDrawable(R.mipmap.v2),
                getResources().getDrawable(R.mipmap.v3),
                getResources().getDrawable(R.mipmap.v4),
                getResources().getDrawable(R.mipmap.v5),
                getResources().getDrawable(R.mipmap.v6),
                getResources().getDrawable(R.mipmap.v7),};
    ...
    public void showReleaseToCancelHint() {
        ...
        voiceImage.setImageResource(R.mipmap.cancel);
    }

    public void showMoveUpToCancelHint() {
        recordingHint.setText(context.getString(R.string.move_up_to_cancel));
        micImage.setVisibility(VISIBLE);
        voiceImage.setImageResource(R.mipmap.recorder);
    }
