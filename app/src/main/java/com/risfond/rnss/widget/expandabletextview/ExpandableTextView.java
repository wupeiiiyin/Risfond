...
package com.risfond.rnss.widget.expandabletextview;
...
public class ExpandableTextView extends LinearLayout implements View.OnClickListener {
    ...
    private void init(AttributeSet attrs) {
        ...
        TypedArray typedArray = getContext().obtainStyledAttributes(attrs, R.styleable.ExpandableTextView2);
        mMaxCollapsedLines = typedArray.getInt(R.styleable.ExpandableTextView2_maxCollapsedLines, MAX_COLLAPSED_LINES);
        mAnimationDuration = typedArray.getInt(R.styleable.ExpandableTextView2_animDuration, DEFAULT_ANIM_DURATION);
        mExpandDrawable = typedArray.getDrawable(R.styleable.ExpandableTextView2_expandDrawable);
        mCollapseDrawable = typedArray.getDrawable(R.styleable.ExpandableTextView2_collapseDrawable);

        textCollapse = typedArray.getString(R.styleable.ExpandableTextView2_textCollapse);
        textExpand = typedArray.getString(R.styleable.ExpandableTextView2_textExpand);
        ...
        contentTextColor = typedArray.getColor(R.styleable.ExpandableTextView2_contentTextColor, ContextCompat.getColor(getContext(), R.color.color_home_black_text));
        contentTextSize = typedArray.getDimension(R.styleable.ExpandableTextView2_contentTextSize, UIUtil.sp2px(getContext(), 14));

        collapseExpandTextColor = typedArray.getColor(R.styleable.ExpandableTextView2_collapseExpandTextColor, ContextCompat.getColor(getContext(), R.color.color_dynamics_blue));
        collapseExpandTextSize = typedArray.getDimension(R.styleable.ExpandableTextView2_collapseExpandTextSize, UIUtil.sp2px(getContext(), 14));

        grarity = typedArray.getInt(R.styleable.ExpandableTextView2_collapseExpandGrarity, Gravity.LEFT);
        drawableGrarity = typedArray.getInt(R.styleable.ExpandableTextView2_drawableGrarity, Gravity.RIGHT);
     ...
     * @param text
     */
    public void setText(CharSequence text, boolean collapsed) {
