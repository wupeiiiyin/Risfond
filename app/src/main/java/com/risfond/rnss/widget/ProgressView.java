...
//        });
    ...
    protected void onDraw(Canvas canvas) {
        this.paint.setColor(ContextCompat.getColor(context, R.color.panel_bottom_blue));
         ...
         * 绘制仪表盘进度
         */
        this.paint.setColor(ContextCompat.getColor(context, R.color.orange_FF7A21));
...
//        }
        ...
        this.paint.setColor(ContextCompat.getColor(context, R.color.color_white));
