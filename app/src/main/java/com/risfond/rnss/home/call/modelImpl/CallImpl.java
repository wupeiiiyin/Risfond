package com.risfond.rnss.home.call.modelImpl;
...
import com.risfond.rnss.entry.CallResponse;
...
public class CallImpl implements ICall {
    ...
    @Override
    public void callRequest(String token, Map<String, String> request, String url, final ResponseCallBack callBack) {
        ...
        HttpUtil.getInstance().requestService(url, request, token, new ResponseListener() {
            ...
            public void onSuccess(String str) {
                if (JsonUtil.isJson(str)) {
                    response = JsonUtil.fromJson(str, CallResponse.class);
                    if (response != null) {
