...
public class WorkOrderForwardImpl implements IHttpRequest {
    WorkOrderForwardResponse response;
        ...
        HttpUtil.getInstance().requestService(url, request, token, new ResponseListener() {
            ...
            public void onSuccess(String str) {
                if (JsonUtil.isJson(str)) {
                    response = JsonUtil.fromJson(str, WorkOrderForwardResponse.class);
                    if (response != null) {
