...
import com.risfond.rnss.entry.WorkOrderDetailResponse;
...
public class WorkOrderDetailImpl implements IHttpRequest {
        ...
        HttpUtil.getInstance().requestService(url, request, token, new ResponseListener() {
            ...
            public void onSuccess(String str) {
                if (JsonUtil.isJson(str)) {
                    response = JsonUtil.fromJson(str, WorkOrderDetailResponse.class);
                    if (response != null) {
