package com.risfond.rnss.home.commonFuctions.performanceManage.modelImpl;
...
public class PerformanceManageImpl implements IPerformanceManage {
        ...
        HttpUtil.getInstance().requestService(url, request, token, new ResponseListener() {
            ...
            public void onSuccess(String str) {
                if (JsonUtil.isJson(str)) {
                    response = JsonUtil.fromJson(str, performanceSearchResponse.class);
                    if (response != null) {
