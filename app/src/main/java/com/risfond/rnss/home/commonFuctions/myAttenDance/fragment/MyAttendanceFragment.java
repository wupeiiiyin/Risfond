...
public class MyAttendanceFragment extends BaseFragment implements ResponseCallBack {
    ...
    public void init(Bundle savedInstanceState) {
        ...
        adapter = new MyAttendanceAdapter(mContext, customerSearches);
    ...
    private void customerRequest() {
        ...
        iCustomerSearch.positionSearchRequest(SPUtil.loadToken(mContext), request, URLConstant.URL_MY_ATTENDANCE, this);
    }
