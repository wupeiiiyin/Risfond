...
public class ResumeDetailActivity extends BaseActivity {
    ...
    public void init(Bundle savedInstanceState) {
        context = ResumeDetailActivity.this;
        id = getIntent().getStringExtra("id");
        url = URLConstant.URL_RESUME_DETAIL_H5 + "staffid=" + SPUtil.loadId(context) + "&id=" + id + "&token=" + SPUtil.loadToken(context);
        initWebView();
        title = "简历详情";
    ...
    @Subscribe
    public void onEventBus(final ResumeInfo eventBus) {

        runOnUiThread(new Runnable() {
            @Override
            public void run() {

                final ResumeInfo.Data data = eventBus.getData();
                if (data != null) {
                ...
                llTitleShare.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        AddGroupActivity.startAction(context, resumeSearch);
