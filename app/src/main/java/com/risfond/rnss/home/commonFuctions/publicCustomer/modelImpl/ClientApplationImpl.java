package com.risfond.rnss.home.commonFuctions.publicCustomer.modelImpl;
...
public class ClientApplationImpl implements IClientApplication {
        ...
        HttpUtil.getInstance().requestService(url, request, token, new ResponseListener() {
            ...
            public void onSuccess(String str) {
                if (JsonUtil.isJson(str)) {
                    response = JsonUtil.fromJson(str, ClientApplicationResponse.class);
                    if (response != null) {
