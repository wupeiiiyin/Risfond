...
public class PublicCustomerActivity extends BaseActivity implements ResponseCallBack {
    ...
    public void init(Bundle savedInstanceState) {
        context = PublicCustomerActivity.this;
        tvTitle.setText("公共客户");
    ...
    public void onClick(View v) {
        if (v.getId() == R.id.ll_title_search) {
            PublicCustomerSearchActivity.StartAction(context);
        }
    }

    public static void StartAction(Context context) {
        Intent intent = new Intent(context, PublicCustomerActivity.class);
