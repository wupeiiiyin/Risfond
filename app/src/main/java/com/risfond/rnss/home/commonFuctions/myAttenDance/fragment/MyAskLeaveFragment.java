...
import com.risfond.rnss.home.commonFuctions.myAttenDance.adapter.MyAskLeaveAdapter;
...
public class MyAskLeaveFragment extends BaseFragment implements ResponseCallBack {
    ...
    private MyAskLeaveAdapter adapter;
    ...
    public MyAskLeaveFragment(Context context) {
    ...
    public void init(Bundle savedInstanceState) {
        ...
        adapter = new MyAskLeaveAdapter(mContext, customerSearches);

        rvResumeList.setLayoutManager(new LinearLayoutManager(mContext));
//        rvResumeList.addItemDecoration(new RecycleViewDivider(mContext, LinearLayoutManager.HORIZONTAL, 1, ContextCompat.getColor(mContext, R.color.color_home_back)));
    ...
    private void customerRequest() {
        ...
        iCustomerSearch.positionSearchRequest(SPUtil.loadToken(mContext), request, URLConstant.URL_MY_ASKLEAVE, this);
    }

    @Override
    public int getLayoutResId() {
        return R.layout.fragment_my_aslleave;
    }
