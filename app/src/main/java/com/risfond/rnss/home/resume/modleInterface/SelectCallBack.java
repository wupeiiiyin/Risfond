...
public interface SelectCallBack {
    ...
    void onMoreConfirm(List<String> recommends, String age_from, String age_to, List<String> sexs,List<String> sexs_text,
                       String salary_from, String salary_to, List<String> languages,List<String> languages_text, String page);
