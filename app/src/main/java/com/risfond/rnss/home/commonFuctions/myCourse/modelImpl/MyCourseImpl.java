package com.risfond.rnss.home.commonFuctions.myCourse.modelImpl;
...
public class MyCourseImpl implements IMyCourse {
        ...
        HttpUtil.getInstance().requestService(url, request, token, new ResponseListener() {
            ...
            public void onSuccess(String str) {
                if (JsonUtil.isJson(str)) {
                    response = JsonUtil.fromJson(str, MyCourseResponse.class);
                    if (response != null) {
