...
public class SuccessCaseHistoryAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public SuccessCaseHistoryAdapter(Context context, List<String> histories) {
