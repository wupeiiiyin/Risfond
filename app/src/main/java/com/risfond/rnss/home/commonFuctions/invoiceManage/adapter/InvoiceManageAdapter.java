...
public class InvoiceManageAdapter extends RecyclerView.Adapter {
    ...
    public InvoiceManageAdapter(Context context, List<InvoiceSearch> data) {
    ...
    public ResumeViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.item_invoice_manage_page, parent, false);
