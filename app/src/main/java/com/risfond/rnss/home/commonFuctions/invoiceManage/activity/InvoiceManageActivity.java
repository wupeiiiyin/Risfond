 ...
 * 发票管理页面
 */
public class InvoiceManageActivity extends BaseActivity implements ResponseCallBack {
    ...
    public void init(Bundle savedInstanceState) {
        context = InvoiceManageActivity.this;
        tvTitle.setText("发票管理");
    ...
    public void onClick(View v) {
        if (v.getId() == R.id.ll_title_search) {
            InvoiceManageSearchActivity.StartAction(context);
        }
    }

    public static void StartAction(Context context) {
        Intent intent = new Intent(context, InvoiceManageActivity.class);
