 ...
 * 客户满意度调查H5交互页面
 */
public class EvaluateViewActivity extends BaseActivity {
    ...
    public void init(Bundle savedInstanceState) {
        context = EvaluateViewActivity.this;
        url = URLConstant.URL_SATISFACTION_H5 + "?staffId=" + SPUtil.loadId(context);
        initWebView();
        title = "客户满意度调查";
    ...
    public static void startAction(Context context) {
        Intent intent = new Intent(context, EvaluateViewActivity.class);
